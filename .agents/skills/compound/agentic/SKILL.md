...
Evidence: AGENTS.md, AGENTS.md, or similar
Score 0: No agent-facing entry point document
Score 1: README exists but not optimized for agents
Score 2: Dedicated AGENTS.md or AGENTS.md with commands, structure, conventions
...
3. Use Glob and Grep to check for evidence of each principle:
   - Glob for: docs/**, *.test.*, *_test.go, test_*.py, *_test.rs, .eslintrc*, AGENTS.md, AGENTS.md
