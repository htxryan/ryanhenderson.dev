...
## Pre-Review Setup
1. Read `.Codex/skills/compound/build-great-things/SKILL.md` — specifically the **Mandatory Quality Checklist** and **Common AI Laziness Patterns** sections. These are your evaluation rubric.
...
## Literature
- Read `.Codex/skills/compound/build-great-things/SKILL.md` for the complete quality checklist and design philosophy
