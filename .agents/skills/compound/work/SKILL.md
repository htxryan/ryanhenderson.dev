...
8. Deploy an **AgentTeam** (TeamCreate + Task with `team_name`) with MULTIPLE test-writers and implementers:
   - Role skills: `.Codex/skills/compound/agents/{test-writer,implementer}/SKILL.md`
...
If REJECTED: fix ALL issues, re-run required evidence, resubmit. INVIOLABLE per AGENTS.md.
