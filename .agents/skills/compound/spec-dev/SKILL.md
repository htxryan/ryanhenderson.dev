...
4. Spawn subagents for research (`.Codex/agents/compound/repo-analyst.md`, `memory-analyst.md`, or `subagent_type: Explore`)
...
## Reference Material
Read `.Codex/skills/compound/spec-dev/references/spec-guide.md` on demand for EARS patterns, Mermaid templates, ambiguity checklists, and trade-off frameworks.
